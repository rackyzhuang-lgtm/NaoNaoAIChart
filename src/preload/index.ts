...
const electronHandler: ElectronIPC = {
  ...
  sub2api: {
    ...
    getUsageErrors: (page) => ipcRenderer.invoke(SUB2API_IPC_CHANNELS.getUsageErrors, page),
    getUsageErrorDetail: (id) => ipcRenderer.invoke(SUB2API_IPC_CHANNELS.getUsageErrorDetail, id),
    ...
    getModelPlaza: () => ipcRenderer.invoke(SUB2API_IPC_CHANNELS.getModelPlaza),
