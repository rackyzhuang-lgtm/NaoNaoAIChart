export default {
    ...
    canvas: {
        ...
        resetView: "重置视图",
        zoom: "放大/缩小画布",
        agentConnected: "NaoNaoAI Agent 已连接",
        agentConnecting: "NaoNaoAI Agent {{activity}}",
        agentDisconnected: "NaoNaoAI Agent 未连接",
        connecting: "连接中",
        openAgent: "打开 NaoNaoAI Agent 面板",
    ...
    agent: {
        ...
        state: { ready: "就绪", connectionRequired: "请先在 NaoNaoAI Chat 中配置文本模型", invalidUrl: "内置 Agent 地址格式不正确", offline: "离线", skillReadFailed: "读取 Skill 失败", skillParseFailed: "Skill 解析失败", requestFailed: "内置 Agent 请求失败" },
        ...
        connect: { builtinTitle: "内置 NaoNaoAI Agent", builtinDescription: "Agent 由 NaoNaoAI Chat 内置提供，自动使用当前文本模型，无需安装其他软件。", builtinStarting: "正在连接内置 Agent", title: "Agent 连接", description: "当前 Agent 由 NaoNaoAI Chat 提供，无需外部插件或命令。", disconnect: "断开", connect: "连接" },
        ...
        eventMore: { toolRunning: "{{action}}中…", openedRoute: "已打开{{route}}", canvasCount: "共 {{count}} 个画布", promptCount: "找到 {{count}} 条提示词", assetCount: "共 {{count}} 个资产", assetAdded: "已加入我的素材", generationStatus: "共 {{total}} 个任务，排队 {{queued}}，运行中 {{running}}，成功 {{succeeded}}，失败 {{failed}}", workbenchExecuted: "已在工作台执行", workbenchConfigRead: "已读取工作台配置", canvasRead: "已读取当前画布内容", selectionRead: "已读取当前选中内容", textNodes: "{{count}} 个文本", imageNodes: "{{count}} 张图片", configNodes: "{{count}} 个配置", videoNodes: "{{count}} 个视频", audioNodes: "{{count}} 个音频", groupNodes: "{{count}} 个分组", otherNodes: "{{count}} 个其他节点", connections: "{{count}} 条连线", emptyCanvas: "当前画布为空", executeTool: "执行{{tool}}", thinking: "正在思考...", operationRunning: "{{operation}}正在进行...", organizingCanvas: "画布已读取，NaoNaoAI Agent 正在整理结果...", operationCompleted: "{{operation}}已完成，NaoNaoAI Agent 正在继续处理...", attachmentPrompt: "请处理上传的图片附件。", routes: { home: "首页", canvas: "画布页面", canvasProject: "指定画布", image: "生图工作台", video: "视频工作台", prompts: "提示词中心", assets: "我的素材", config: "配置页面" } },
        runtime: {
            mcpStarting: "正在启动 MCP：{{name}}", mcpConnecting: "正在建立工具连接并读取可用工具列表", mcpReadyNamed: "MCP 已就绪：{{name}}", toolsReady: "工具列表加载完成，可以开始对话", mcpFailedNamed: "MCP 启动失败：{{name}}", mcpCanceledNamed: "MCP 启动已取消：{{name}}", toolInitFailed: "工具服务未能完成初始化", mcpServicesStarting: "正在启动 MCP 服务", toolServicesPending: "还有 {{count}} 个工具服务正在初始化", checkingToolServices: "正在确认工具服务状态", conversationInitializing: "正在初始化 NaoNaoAI Agent 对话", conversationCreating: "正在创建会话并启动画布工具服务", someMcpFailed: "部分 MCP 服务初始化失败", remainingToolsReady: "其余工具已就绪，可以开始对话", conversationInitFailed: "NaoNaoAI Agent 对话初始化失败", conversationCreateFailed: "无法创建 NaoNaoAI Agent 会话", mcpServicesReady: "{{count}} 个 MCP 服务已完成初始化", toolInitCanceled: "工具服务初始化已取消", mcpStatusComplete: "MCP 状态确认完成", mcpListRead: "已读取 NaoNaoAI Agent 返回的完整工具服务清单",
            historyReadFailed: "读取历史失败", conversationSyncFailed: "同步会话失败", agentOutdated: "内置 Agent 版本过旧，请重启 NaoNaoAI Chat 后重新连接", restartRequired: "需要重启应用", versionMismatch: "Agent 版本不匹配", awaitingApproval: "等待权限确认", codexRunning: "NaoNaoAI Agent 正在运行", connected: "已连接", localAgentConnected: "NaoNaoAI Agent 已连接", processingFailed: "处理失败", completed: "完成", approvalGranted: "已批准权限", approvalCanceled: "已取消权限", log: "日志", connectionLostDescription: "内置 Agent 连接失败或已断开", connectionFailedDescription: "内置 Agent 连接失败，请重启应用后重试", connectionLost: "连接断开", connectionFailed: "连接失败", modelListFailed: "读取模型列表失败",
            ...
            submittingApproval: "正在提交权限决定", waitingCodexApproval: "等待 NaoNaoAI Agent 确认权限", approvalFailed: "权限审批失败", enableFullAccess: "启用完全访问权限", fullAccessDescription: "NaoNaoAI Agent 将不受沙箱限制，可访问互联网及本机任意文件。请仅在信任当前任务时使用。", enableFullAccessAction: "启用完全访问", offline: "离线", addressRequired: "内置 Agent 地址由应用自动提供", agentNotFound: "未检测到内置 Agent，请重启 NaoNaoAI Chat 后重试", invalidAddress: "内置 Agent 地址格式不正确", connecting: "连接中", creatingConversation: "正在新建对话", newConversation: "新对话", newConversationFailed: "新建对话失败", conversationResumed: "已恢复会话", resumeConversationFailed: "恢复对话失败", recordsDeleted: "已删除 {{count}} 条记录", deleteConversationFailed: "删除对话失败", deleteConversations: "删除 {{count}} 条对话记录", deleteConversationsDescription: "删除后无法恢复，确定继续吗？", importGeneratedImages: "导入生成图片", addedToSourceCanvas: "已添加到发起任务的画布", imageGenerated: "图片已生成", noImageAttachments: "没有可添加的图片附件", invalidAttachmentNode: "图片附件节点参数无效", attachmentReadFailed: "读取图片附件失败", referenceImage: "参考图", generatedImageReadFailed: "读取 NaoNaoAI Agent 生成图片失败", generatedImageName: "生成图片 {{index}}",
        },
    },
    locale: {
        zhCN: "简体中文",
