...
5. macOS 清除 `@electron/get` 会优先读取的 Electron mirror/custom-dir 环境变量，Electron 本体和 electron-builder 辅助二进制文件均使用 GitHub 官方来源；npm 包仍可使用 npmmirror。Windows 保持已经验证成功的镜像配置。
